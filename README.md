...
.agents/                           Agentic analysis prompts and experiment rationale
...
That file is not generated by a script. It is meant to be written by an analysis agent after the experiments run. The agent task lives in:
...
4. Use `.agents/experiment-rationale.md` to reason about expected architecture behavior.
